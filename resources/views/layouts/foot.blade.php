...
<script src="front/assets/vendor/nice-select/js/jquery.nice-select.min.js"></script>
  
<script src="front/assets/vendor/fancybox/js/jquery.fancybox.min.js"></script>

<script src="front/assets/vendor/wow/wow.min.js"></script>

<script src="front/assets/vendor/animateNumber/jquery.animateNumber.min.js"></script>

<script src="front/assets/vendor/waypoints/jquery.waypoints.min.js"></script>

<script src="front/assets/js/google-maps.js"></script>
  
<script src="front/assets/js/topbar-virtual.js"></script>
