...
<body class="theme-red">
  ...
  <div class="vg-page page-home mb-5" id="home" style="background-image: url({{asset($home_page->background)}})">
      <!-- Navbar -->
                  ...
                  <ul class="nav ml-auto">
                      <li class="nav-item">
                          @if (Auth::guard('site')->check())
                              <a href="{{route('profile')}}" data-animate="scrolling" class="text-light mr-4">
                                  @php echo Auth::guard('site')->user()->name.' '.Auth::guard('site')->user()->surname @endphp
